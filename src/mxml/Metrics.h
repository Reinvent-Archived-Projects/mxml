...
public:
     ...
     */
    static coord_t noteY(const ScoreProperties& scoreProperties, const dom::Note& note);
    ...
    /**
     ...
     line going down.
     */
    static coord_t staffY(const ScoreProperties& scoreProperties, const dom::Note& note);
